  ...
  <body>
    ...
    <div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item">
          <img alt="900x500" src="http://nzxtshop.com/public/upload/528bdc55942c6.jpg">
...
<div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive" alt="500x500" src="http://www.wingwire.com/app/webroot/files/4_97_1338244299.jpg">
        </div>
        <div class="col-md-7">
